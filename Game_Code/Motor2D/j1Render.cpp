...
// Blit to screen
bool j1Render::Blit(SDL_Texture* texture, int x, int y, const SDL_Rect* section, int rect_scale, float speed, double angle, int pivot_x, int pivot_y) const
{
	bool ret = true;
	...
	rect.w *= scale * rect_scale;
	rect.h *= scale * rect_scale;
